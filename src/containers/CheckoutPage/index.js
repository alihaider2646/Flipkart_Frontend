    ...
    return (
        <div className="checkoutStep">
            <div
                ...
                // this below line add by me 
                style={props.style}
                // this above line add by me 
                ...
                <div className="checkoutContainer">
                    ...
                    <CheckoutStep
                        ...
                        body={auth.authenticate ? (
                            <div className="loggedInId" style={{ padding: '0 0 20px 0' }}>
                                <span style={{ fontWeight: 'bolder' }}>{capitalizeWords(auth.user.fullName)}</span>
                    ...
                    <CheckoutStep
                        ...
                        body={
                            <>
                                {confirmAddress ? (
                                    <div className="stepCompleted">{<strong>{selectedAddress.name}</strong>}{` - ${selectedAddress.address} - ${selectedAddress.pinCode}`}</div>
                                ) : (
                                        address.map((adr) => (
                                            <Address
